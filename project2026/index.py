...
# 2. 고정 설정값
# -----------------------------
BASE_URL = "https://volunteers-lines-korea-forestry.trycloudflare.com/v1"
...
추가 규칙:
- 위협 요소가 있을 경우, 반드시 방향과 대략적인 거리(걸음 수)를 함께 설명해라.
- 방향은 "앞쪽", "왼쪽", "오른쪽", "뒤쪽" 중 하나를 사용해라.
- 거리 표현은 "약 2걸음", "약 3~4걸음"처럼 자연스럽게 써라.
- 예: "앞쪽 계단 약 3걸음 거리", "오른쪽 장애물 약 2걸음 거리"
- 위험 요소가 없으면 거리와 방향은 생략한다.
